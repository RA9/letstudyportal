...
export const Sidebar = () => {
  ...
  return (
    <>
      <aside className="flex w-64 flex-col bg-[#eef4ff] p-4 tet-[#bec2ca]">
        ...
        <nav className="flex flex-1 flex-col gap-2">
          <Button
            ...
            variant="ghost"
            className="justify-start  hover:bg-blue-600"
          >
            <Home className="mr-2 h-4 w-4" />
            Dashboard
          </Button>
          <Button
            onClick={() => redirectLink("/schools")}
            variant="ghost"
            className="justify-start hover:bg-blue-600"
          >
          ...
          <Button
            onClick={() => redirectLink("/application")}
            variant="ghost"
            className="justify-start hover:bg-blue-600"
          >
